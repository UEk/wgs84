...
describe('My WGS84 GeoJson library', function toast() {
    ...
    describe('should be able to calculate correct distances at the equator', function toast() {
        ...
        const delta: number =
            Math.sqrt((110.574 * 110.574) / 3600 + (111.32 * 111.32) / 3600) * 1000;
    ...
    describe('should be able to calculate correct distances at various latitudes', function toast() {
        // distance of 1 second (1/60 of a degree) at the equator
        // See https://en.wikipedia.org/wiki/Latitude for length of a degree
        ...
        test('should be able to calculate the distance at 30 degrees south', function toast() {
            ...
            const p: Point = { coordinates: [lon, lat], type: 'Point' };
            const delta = Math.sqrt(deltaN * deltaN + deltaE * deltaE);
        ...
        test('should be able to calculate the distance at 30 degrees south with height', function toast() {
            ...
            const delta = Math.sqrt(deltaN * deltaN + deltaE * deltaE + deltaH * deltaH);
    ...
    describe('should be able to calculate new positions', function toast() {
